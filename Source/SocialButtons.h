...
public:
    SocialButtons()
    {
        ...
        b->addListener (this);
        auto ffLogo = juce::ImageCache::getFromMemory (BinaryData::LogoFF_png, BinaryData::LogoFF_pngSize);
        ...
        b->addListener (this);
        auto fbLogo = juce::ImageCache::getFromMemory (BinaryData::FBlogo_png, BinaryData::FBlogo_pngSize);
        ...
        b = buttons.add (new juce::ImageButton());
        b->addListener (this);
        auto inLogo = juce::ImageCache::getFromMemory (BinaryData::Inlogo_png, BinaryData::Inlogo_pngSize);
        ...
        b = buttons.add (new juce::ImageButton());
        b->addListener (this);
        auto githubLogo = juce::ImageCache::getFromMemory (BinaryData::GitHublogo_png, BinaryData::GitHublogo_pngSize);
    ...
    {
        auto renderedText = juce::ImageCache::getFromMemory (BinaryData::FFtext_png, BinaryData::FFtext_pngSize);
